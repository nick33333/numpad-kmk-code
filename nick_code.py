'''
Notable differences:
- RGB LED information line is on GPIO 22
- Rotary encoder A, B order is changed kinda, just wanted to turn clockwise
  for increasing volume and turn cc-wise for decreasing volume.
'''
...
encoder_handler.pins = ((board.GP10, board.GP11, board.GP9, False),)
